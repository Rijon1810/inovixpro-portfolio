        ...
        <section className={styles.section}>
            <div className={styles.textContainer}>
                ...
                <p className={styles.subtitle}>
                    We implement thoughtful brand and product experiences that make our <br/>
                    clients look like they’re $1B organizations.
                </p>
            </div>
            ...
            <div className={styles.imageTextContainer}>
                ...
                <div className={styles.contentContainer}>
                    <div className={styles.contentSection}>
                        <p className={styles.highlight}>Best solutions</p>
                    ...
                    <div className={styles.contentSection}>
                        ...
                        <p className={styles.sectionText}>
                            Scelerisque dignissim in leo at magna donec mi metus ipsum luctus<br/>
