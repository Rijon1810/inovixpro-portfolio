...
const Footer = () => {
  return (
    <div className={styles.wrapper}>
      <div className={styles.title}>Have an idea?</div>
      <div className={styles.letsTalk}>Lets Talk</div>
      <Image height={28} width={124} src="/bottom-logo.svg" alt="logo" />
      <div className={styles.horizontalLine} />
      <div className={styles.bottomContent}>
        <div className={styles.copyright}>
          © 2024 Inovixpro. All rights reserved.
        </div>
        <div className={styles.socialList}>
          ...
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_177_2495)">
              <path
      ...
      <Image height={330} width={300} src="/top-right-circle.png" alt="logo" className={styles.topRightCircle} />
      <Image height={300} width={230} src="/bottom-left-circle.png" alt="logo" className={styles.bottomLeftCircle} />
    </div>
  );
};
